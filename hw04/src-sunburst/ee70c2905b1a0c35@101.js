...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作地點為工作室的占最大部分</li>
    <li>大部分的藝術工作者採用減少包裝、使用再生材料、節約能源來減少碳排放</li>
    <li>除了美術館是利用節約能源作為主要減少碳排放的行動之外，其餘藝術工作者皆以減少包裝作為減少碳排的主要行動</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["工作室", "替代空間", "美術館", "減少包裝材及文宣印製", "使用無毒媒材、再生材料、廢物利用素材等", "工作場所、活動展場的節約能源", "非營利組織/藝術團體"])
